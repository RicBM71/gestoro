...
class KlCategoriasSeeder extends Seeder
{
    ...
    private function update(){
        ...
        DB::statement('UPDATE klt_productos set categoria_id = 4 WHERE categoria_id IS NULL AND nombre LIKE "%CORDON%"');
        //DB::statement('UPDATE klt_productos set categoria_id =  WHERE categoria_id IS NULL AND nombre LIKE "%GARGANTILLA%"');
        ...
        //DB::statement('UPDATE klt_productos set categoria_id =  WHERE categoria_id IS NULL AND nombre LIKE "%ANILLO%"');
